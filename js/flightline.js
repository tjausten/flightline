$(function() {
  ...
  var trip = JSON.parse(stringData);
  
  // Set map size to window
  ...
  // Apply svg objects to map projection and points
  ...
  // Create object for airports on map
  var airportMap = {};

  // Animate airplane during flight transition
  ...
  // Adjust airplane direction to match flight path
  ...
  // Draw flight route and airplane
  ...
  // Draw countries and airports on map
  function loaded(error, countries, airports) {
    ...
    svg.append("g")
       ...
       .enter()
       .append("path")
       .attr("abbrev", function(d) {return d.properties.abbrev;})
       .attr("d", path);
    ...
    // Calculate interval between flights and loop through flights
    var i = 0;
  ...
  // Load json data for countries and airports
